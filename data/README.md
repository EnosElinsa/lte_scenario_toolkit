...
- `datasets.yaml` is the catalog. It contains independent dataset
...
loader rejects duplicate IDs, unknown links, unsafe paths, and unexpected
top-level fields.
...
repository and checks its scenario and points-dataset links without creating
output directories. Boundary and DEM ownership remains entirely in the
catalog.
